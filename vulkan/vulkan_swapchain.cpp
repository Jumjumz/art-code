...
void VulkanSwapchain::create_swapchain(const vk::Extent2D& extent) {
    ...
    const uint32_t queue_family_indices[] = {static_cast<uint32_t>(this->graphics_family),
    ...
    this->swapchain = vk::raii::SwapchainKHR{this->device, swapchain_info, nullptr};
...
void VulkanSwapchain::imgui_create_image_views() {
    ...
    for (auto const& image : this->resources.images) {
        ...
        this->resources.image_views.emplace_back(this->device, image_view_info, nullptr);
